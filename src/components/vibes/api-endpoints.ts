...
export const API_ENDPOINTS: ApiEndpoint[] = [
  ...
  { method: 'POST', path: '/api/vibes/videos/generate', category: 'Generation', description: 'Generate video variations. poll=false returns batchId fast.' },
  { method: 'POST', path: '/api/vibes/videos/extend', category: 'Generation', description: 'Extend an existing video clip by ~5 seconds.' },
  { method: 'POST', path: '/api/vibes/videos/edit', category: 'Generation', description: 'Edit a video with a text prompt.' },
  ...
  { method: 'POST', path: '/api/vibes/upload/image', category: 'Generation', description: 'Upload a base64-encoded image asset.' },
  ...
  { method: 'GET', path: '/api/vibes/media/[itemId]/download', category: 'Media', description: 'Download binary media (?type=video|image).' },
